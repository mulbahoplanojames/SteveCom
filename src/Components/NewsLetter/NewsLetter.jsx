const NewsLetter = () => {
  return (
    <>
      <form className="bg-gray px-10 md:py-24 py-14 flex items-center md:flex-nowrap flex-wrap mb-14">
        ...
        <div className="w-full   mt-4 flex md:flex-nowrap flex-wrap md:gap-3 gap-y-3">
          ...
          />
          <button
            className="text-white md:w-[30%] w-full bg-primary rounded text-lg md:py-1 md:px-4 py-3"
            type="submit"
          >
            Subscribe
          </button>
